    <div class="flecha-pegada-footer">
      ...
      <div class="container">
        <div class="row text-start text-md-center">
          ...
          <div class="col-md-4 mb-4 mb-md-0">
            <img src="<?= BASE_URL ?>plantilla/logo_nuevo.jpeg" style="height: 100px; border-radius:50%" class="mb-3">
          ...
          <div class="col-md-4">
            ...
            <a href="https://www.facebook.com/defensoriadelpueblomgp/?locale=es_LA" class="text-white fs-4 me-3 social-icon" target="_blank"><i class="bi bi-facebook"></i></a>
            <a href="https://www.instagram.com/defensoriamgp/" class="text-white fs-4 me-3 social-icon" target="_blank"><i class="bi bi-instagram"></i></a>
            <a href="https://wa.me/5492236152488" class="text-white fs-4 me-3 social-icon" target="_blank"><i class="bi bi-whatsapp"></i></a>
            <a href="https://x.com/DefensorMGP" class="text-white fs-4 me-3 social-icon" target="_blank"> <i class="bi bi-twitter-x"></i></a>
          </div>
        </div>
